...
window.config = {
  ...
  nft_taraxa_address: "0x2dEeCF2a05F735890Eb3eA085d55CEc8F1a93895",
  ...
  daily_bonus_taraxa_address: "0xbBFd178b9f41C349857b753CE57f0E22089A8de3",
  ...
  infura_endpoint:
    "https://mainnet.infura.io/v3/04ee2486b5344943b461abeb58fbffaf",
  ...
  liquidity_campaign_address: "0x405464fa685FbCEA17dbC6dF3D2170F8e6C48DD4",
  liquidity_tokens: [
    {
...
window.taraxaWeb3 = new Web3(window.config.taraxa_endpoint);
...
window.vanarWeb3 = new Web3(window.config.vanar_endpoint);
...
async function getContractSeiNFT(key) {
  let ABI = window[key + "_ABI"];
  let address = window.config[key.toLowerCase() + "_address"];
  if (!window.cached_contracts[key]) {
    window.web3 = new Web3(window.ethereum);
...
class SEI_NFT {
  constructor(key = "SEI_NFT") {
    ...
    [
      ...
      this[fn_name] = async function (...args) {
        let contract = new window.seiWeb3.eth.Contract(
          window.SEI_NFT_ABI,
          window.config.nft_sei_address,
          {
            from: await getCoinbase(),
  ...
  async mintSeiNFT() {
    let nft_contract = await getContractMatNFT("SEI_NFT");
...
class BNB5YA_NFT {
  ...
  async mintBNB5YANFT() {
    let nft_contract = await getContractBNB5YANFT("BNB5YA_NFT");

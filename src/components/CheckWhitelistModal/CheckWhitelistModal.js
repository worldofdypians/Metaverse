                    ...
                    <div className="d-flex flex-column gap-3">
                        {coinbase ? (
                            <p className="text-white m-0 walletdesc font-poppins">
                                You must join the whitelist first to be part of the beta tester users that
                                will have access to World of Dypians. If you have already joined the whitelist,
                                please check back soon.
                            </p>
                        ) : (
                            <p className="text-white m-0 walletdesc font-poppins">
                                Please connect your wallet to verify if you are whitelisted as a Beta Tester.
                            </p>
                        )}
                    </div>

  ...
  return (
    <div className="marketplace-sidebar d-flex justify-content-center p-4">
      ...
      <div className="d-flex flex-column gap-3">
        ...
        <a href="https://twitter.com/worldofdypians" target="_blank" className="d-flex align-items-center gap-3" style={{textDecoration: 'none'}}>
          <img src={twitterIcon} height={20} width={20} alt="" />
          <img src={emailIcon} height={20} width={20} alt="" />
          <h6 className="social-link">Follow Us</h6>
        </a>
        <a href="https://t.me/worldofdypians" target="_blank" className="d-flex align-items-center gap-3" style={{textDecoration: 'none'}}>

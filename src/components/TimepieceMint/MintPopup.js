    ...
    >
      ...
      {data.title === "CoinGecko" ? (
        ...
        <>
          ...
          <h6 className="mint-popup-title">Dogecoin Treasure Hunt</h6>
        </>
      ) : (
        ...
        <div className="available-mint-bg d-flex align-items-center justify-content-center px-2 py-1">
          {data.title === "Treasure Hunt" && (
            <span className="popup-available-mint">
              Explore the Dogecoin area and use your <img src={whiteExplore} className="white-explore" alt=""/> to generate rewards!
            </span>
          )}
        </div>
      ) : data.title === "DogeCoin" ? (

...
const BnbDailyBonus = ({
  ...
  const [visibleChain, setVisibleChain] = useState("bnb");
                  ...
                  <div className="col-12 col-lg-5 chains-wrapper mt-5 mt-lg-0 d-flex align-items-center">
                    {windowSize.width && windowSize.width > 992 ? (
                      ...
                      >
                        ...
                        <div
                          className={`position-relative chain-item ${
                            visibleChain === "opbnb" && "chain-item-active"
                          } w-100`}
                        >
                          <img
                            src={
                            ...
                            className={`chain-img-2 ${
                              visibleChain === "opbnb" && "chain-img-active"
                            }`}
                            alt=""
                          />
                          <div
                            className={`chain-title-wrapper ${
                              visibleChain === "opbnb" &&
                              "chain-title-wrapper-active"
                            } d-flex align-items-start flex-lg-column justify-content-between`}
                            onClick={() => {
                              setChain("bnb");
                              setVisibleChain("opbnb");
                              setIsActive();
                              setIsActiveIndex();
                              setRewardData([]);
                              handleOpBnbPool();

...
const GoldenTaskItem = () => {
  return (
    <div className="twitter-task-item d-flex flex-column flex-lg-row align-items-center justify-content-between  w-100  p-2 position-relative">
        ...
        >
          ...
          >
            <span className="twitter-post">
              World of Dypians Grand Championship is LIVE! Join thousands of
              players competing for the ultimate prize pool. Like, Comment, and
              Retweet to support the community!
            </span>
          </div>
        </a>
      </div>

    ...
    >
      ...
      {windowSize.width > 786 ? (
            ...
            >
              <div className="d-flex align-items-center gap-1">
                ...
                <span
                  ...
                  style={{
                    color:
                      item?.tasks[1]?.verified &&
                      item?.tasks[1]?.completed &&
                      "#fff",
                  }}
                >
                  Repost
            ...
            >
              <div className="d-flex align-items-center gap-1">
                ...
                <span
                  ...
                  style={{
                    color:
                      item?.tasks[2]?.verified &&
                      item?.tasks[2]?.completed &&
                      "#fff",
                  }}
                >
                  Comment
        ...
        <div className="d-flex align-items-center justify-content-between w-100 mt-2">
          <div className="d-flex align-items-start align-items-lg-center flex-column flex-lg-row gap-2">
            <button
              className={`twitter-action-btn ${
                item?.tasks[0]?.verified && item?.tasks[0].completed
                  ? "twitter-action-btn-disabled"

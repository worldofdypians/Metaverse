...
const DisclaimerModal = ({ onClose }) => {
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gradient-to-br from-slate-900 to-slate-800 bordertw border-blue-500/30 rounded-2xl max-w-2xl w-full shadow-2xl shadow-blue-500/20 max-h-[80vh] overflow-y-auto">
            ...
            <div className="flex items-start gap-3">
              <div>
                ...
                <p className="text-xs text-slate-300 leading-relaxed">
                  ...
                  {/* <span className="bg-orange-300/20 text-orange-300 font-semibold px-1 rounded"> */}
                  increases or decreases relative to USDT
                  {/* </span>{" "} */}
                  during the 3-month lock period, you may receive less value
                  than if you had simply held the stablecoins. The LP rewards
                  and bonus tokens are designed to offset this risk, but{" "}
                  {/* <span className="bg-orange-300/20 text-orange-300 font-semibold px-1 rounded"> */}
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-yellow-300 mb-2">
                  Pool Maturity & Reward Adjustments
                </h4>
                <p className="text-xs text-slate-300 leading-relaxed mb-2">
                ...
                <p className="text-xs text-slate-300 leading-relaxed mb-2">
                  ...
                  (e.g., $500,000 TVL), the{" "}
                  {/* <span className="bg-yellow-300/20 text-yellow-300 font-semibold px-1 rounded"> */}
                  WOD Protocol team reserves the right to adjust the total
                  reward pool amount at our sole discretion

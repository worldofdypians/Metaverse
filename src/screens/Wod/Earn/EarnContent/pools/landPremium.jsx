...
const LandDetailsPremium = ({
  ...
  const claimRewards = async () => {
    ...
    try {
      ...
      window.alertify.error(err?.message || err?.shortMessage || "Claim failed");
              ...
              <div className="container px-0">
                <div className="stats-container my-4">
                  ...
                  <div className="stats-card p-2 d-flex flex-column mx-auto w-100">
                    ...
                    <h6 className="stats-card-content">05 Apr 2024</h6>
                  </div>
                  <div className="stats-card p-2 d-flex flex-column mx-auto w-100">
                  ...
                  <div className="stats-card p-2 d-flex flex-column mx-auto w-100">
                    ...
                    <a
                      ...
                      href={`https://etherscan.io/address/${window.config.nft_land_premiumstake_address}`}

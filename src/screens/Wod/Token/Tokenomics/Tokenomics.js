            ...
            <div className="col-12 col-lg-6">
              ...
              <div className="d-flex flex-column gap-1">
                {tokenomicsData.map((item, index) => (
                  <div
                    className="tokenomics-table-row row d-flex align-items-center justify-content-center p-2"
                    key={index}
                  >
              ...
              <div className="d-flex flex-column align-items-end gap-2">
                <div className="d-flex flex-column">
                  ...
                  <div className="d-flex align-items-center gap-2">
                    <span className="wod-address">0xaC4989037EEb663e267514d9beC258A4108c7C9a</span>
                    <img src={copyIcon} alt="" />
                  </div>
                </div>
                <div className="wod-chart-wrapper w-100 d-flex justify-content-center align-items-center ">
                  <img src={tokenomicsChart} alt="" className="tokenomics-chart" />
                </div>
              </div>
            </div>
          </div>

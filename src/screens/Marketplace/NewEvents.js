                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-12 col-lg-3 ps-lg-0">
                        <div className="d-flex new-event-items-wrapper justify-content-center">
                          <div className="d-flex  flex-column w-100 gap-3 mb-3">
                            <NavLink to="/marketplace/events/treasure-hunt">
                              <div className="">
                                <div
                                  className={`nft-event-package-2 w-100 p-2 d-flex align-items-center gap-2 ${
                      ...
                      <div className="col-12 col-lg-9">
                        <div className={`${selectedPackage === "dyp" && "new-event-items-wrapper"}`}>
                          <div id="selected-package" ref={selected}>
                            {selectedPackage === "treasure-hunt" ? (
                              <div className="col-12 m-auto d-flex flex-column gap-4">
                                {dummyBetaPassData2
                                  .slice(0, 2)
                                  .map((item, index) => (
                                    <BetaEventCard
                                ...
                                >
                                  <div className="d-flex flex-column gap-2 ps-3 pe-3 pt-3 pb-3 pb-lg-0">
                                    ...
                                    <p className="upcoming-mint-desc mb-0">
                                      Claim chests daily for a chance to win
                                      Game Points, exclusive NFTs, and exciting
                                      rewards! Don't miss out on your daily dose
                                      of gaming treasures.
                                    </p>

...
const BetaEventCard = ({data, onOpenPopup}) => {
  return (
      ...
      <div className="d-flex flex-column justify-content-between gap-2 gap-lg-4">
        <div className="d-flex flex-column gap-2">
          <div className="d-flex align-items-center gap-2">
            ...
            <div className={` ${data.eventStatus === "Live" ? "events-page-status-tag-live" : data.eventStatus === "Expired" ? "events-page-status-tag-expired" : "events-page-status-tag-upcoming" } px-2 d-flex align-items-center justify-content-center gap-2`}>
        ...
        <span className="events-page-details d-flex align-items-center gap-2" onClick={onOpenPopup}>
          Event Details
    ...
    <div className="d-flex col col-lg-4 flex-column align-items-center">
      <h6 className="event-my-earnings">${data.myEarnings}</h6>

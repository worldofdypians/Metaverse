      ...
      <div className="video-wrapper flex-column gap-5 d-flex align-items-center justify-content-around justify-content-lg-center">
        ...
        >
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <span className="sys-req" onClick={() => setModal(true)}>System requirements</span>
          </div>
        </div>
        <video
          preload="auto"
       ...
       <OutsideClickHandler onOutsideClick={() => setModal(false)}>
         <div className="system-requirements-modal p-3" id="reqmodal">
          <div className="d-flex align-items-start justify-content-between">
            ...
            <img src={xMark} alt="x mark" style={{cursor: 'pointer'}} onClick={() => setModal(false)} />
          </div>
         ...
         <h6 className="requirements-title">World of Dypians</h6>
          <p className="requirements-content">
            ...
            maps hunting for rewards, special items and digital currency. The
            game features the main character and a cat (NFT) which will begin
            the journey to explore different lands together. World of Dypians is
            a game where players continuously shape the game and capture value
         ...
         <h6 className="requirements-title">
          ...
          <div className="d-flex align-items-center justify-content-center py-3">
            <h6 className="close-modal" onClick={() => setModal(false)}>Close</h6>
          </div>
        </div>
       </OutsideClickHandler>
      ) : (

          ...
          successLink === false && (
            <div className={`${classes.containerbnb} w-100 align-items-center`}>
              <div className="d-flex flex-column gap-3">
                ...
                <span className={classes.createplayertxt2}>
                  Please create a username that will be associated with your
                  game account. This username will be used to identify you in
                  the game and will be visible to other players. Choose a unique
                  username that reflects your personality or gaming style.
                </span>
        ...
        {successLink === true && (
          <div className="d-flex flex-column gap-3 align-items-center h-100 justify-content-center">
            ...
            <h6 className={classes.bottomGroup_graytxt}>
              You have successfully created your game account
            </h6>
          </div>
        )}
      </div>

    ...
    <div className="row">
      <div className="col-12 col-lg-4">
        <div className="diagonal-button-wrapper  d-flex align-items-center">
          <div className="first-diagonal-btn purple-container p-2  d-flex align-items-end">
          ...
          <div className="second-diagonal-btn purple-container p-2  d-flex justify-content-end">
            <div
      ...
      <div className="col-12 col-lg-8 ps-lg-0 mt-3 mt-lg-0">
        ...
        {dummyPromotions.map((item, index) => (
           <div className="d-flex flex-column flex-lg-row gap-4 gap-lg-0 align-items-center justify-content-between w-100">
           <div className="d-flex align-items-center gap-2">
             ...
             <div className="d-flex flex-column gap-2">
               ...
               <div className="d-flex align-items-center gap-2">
                 <h6 className="promotion-item-title mb-0">{item.item_type} #{item.item_id}</h6>
           ...
           <div className="d-flex flex-column align-items-center align-items-lg-end gap-2">
             <div className="d-flex align-items-center gap-2">
               <span className="promotion-header">Buy now and recieve:</span>
               <div className="d-flex align-items-center gap-1">
                 <img src={item.reward_type === "Stars" ? star : item.reward_type === "DYP" ? dypIcon : iDypIcon} height={15} width={15} alt="" />
                 <span

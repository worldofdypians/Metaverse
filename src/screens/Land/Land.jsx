...
const Land = ({
  ...
  // Use global Redux wallet modal instead of local state
  // const { walletModal, setWalletModal } = (() => {
  //   const { walletModal, setWalletModal } = useWallet();
  //   return { walletModal, setWalletModal };
  // })();
  const { walletModal, setWalletModal } = useWallet();
  ...
  const showWalletConnect = () => setWalletModal(true);
